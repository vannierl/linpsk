 ...
 *   hb9eid: correction of x,y position
 *   of both frequency editor and wide narrow  buttons. look at hb9eid tag.
 ***************************************************************************/
...
width=this->width();
height=this->height();
//hb9eid correction for left margin
//xpos=width*LEFTANDRIGHTMARGIN/100;//hb9eid original
xpos=0;//hb9eid correction
//ypos=height*TOPANDBOTTOM/100;//hb9eid original
ypos=height*TOPANDBOTTOM/90;//hb9eid correction
innerwidth=width-2*xpos;
//innerheight=height*LABELHEIGHT/100;//hb9eid original
innerheight=height*LABELHEIGHT/110;//hb9eid correction
Frequency->setGeometry(xpos,ypos,innerwidth,innerheight);
ypos=ypos+innerheight;
innerwidth=innerwidth/2;
//xpos = xpos -2;//hb9eid original
xpos = xpos;//hb9eid correction
